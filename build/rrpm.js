    ...
    value: function render() {
      ...
      return React__default.createElement(
        ...
        React__default.createElement(
          ...
          React__default.createElement(FontAwesome, { name: 'rocket', size: '2x' })
        ),
        React__default.createElement(
          'div',
          {
  ...
  createClass(PopupTable, [{
    ...
    value: function render() {
      ...
      while (children.length % rowItems !== 0) {
        children.push(React__default.cloneElement(children[children.length - 1]));
      }
      ...
      return React__default.createElement(
        'div',
        { className: style$1.PopupTable, style: { width: 'calc(' + width + 'px - 10px)' } },
        children.map(function (child, i) {
          return React__default.createElement(
            'div',
            { className: i < children.length - items ? style$1.item : style$1.placeholder },
            child
          );
        })
      );
